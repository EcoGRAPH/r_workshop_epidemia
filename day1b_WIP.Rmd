...
There are three main differences between how a tibble is printed in your console and how a data frame is printed. We use a large dataset containing epideiological data to issustrate some differences. First we load the data. 

```{r}
library(readr)
data <- read_csv(file = "epi_data_2017W42.csv")
```
