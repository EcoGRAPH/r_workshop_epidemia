...
1. Double-click on **setup-2.9.6850.exe** (or, if you know you have a 64-bit system, use setup-2.9.6850-x64.exe).

<!-- Get screenshots of below when test installing on laptop -->

2. Click on the option for MiKTeX **Installation**.

3. Select the folder */EPIDEMIA_workshop/Setup/MiKTeX_files* (or /EPIDEMIA_workshop/Setup/MiKTeX_files_x64 for 64-bit).

4. **Very important:** In the step below, CHECK the box for **add to PATH**. 

5. Sometime before the epidemiar section starts this week, you MUST restart your laptop to finish setting up MiKTeX. 
